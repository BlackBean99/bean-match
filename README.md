...
- 운영자는 사용자 상세에서 프로필 열람 토큰과 참가자 개인 초대 링크를 발급하고, 카카오톡 문구 복사 버튼으로 개인 전용 안내 문구를 바로 복사할 수 있습니다. `/offer/pool/{userId}` 에서 같은 성별을 제외한 소개 가능 후보를 보여 주며, 토큰으로 접속한 사용자는 최대 3명까지 관심을 제출할 수 있습니다.
